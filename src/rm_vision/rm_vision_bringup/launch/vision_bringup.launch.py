...
def generate_launch_description():
    ...
    from common import node_params, launch_params, robot_state_publisher, armor_tracker_node, lob_vision_node
    ...
    delay_lob_vision_node = TimerAction(
        period=1.5,
        actions=[lob_vision_node],
    )
