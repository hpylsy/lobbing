...
{
  new (message_memory) building_transform_interface::msg::TimeInfo(_init);
}

void TimeInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<building_transform_interface::msg::TimeInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TimeInfo_message_member_array[2] = {
  {
    ...
    offsetof(building_transform_interface::msg::TimeInfo, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(building_transform_interface::msg::TimeInfo, time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TimeInfo_message_members = {
  ...
  2,  // number of fields
  sizeof(building_transform_interface::msg::TimeInfo),
...
{
  return &::building_transform_interface::msg::rosidl_typesupport_introspection_cpp::TimeInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, building_transform_interface, msg, TimeInfo)() {
  return &::building_transform_interface::msg::rosidl_typesupport_introspection_cpp::TimeInfo_message_type_support_handle;
}
