...
#include "geometry_msgs/msg/detail/point__functions.h"  // kpts
#include "geometry_msgs/msg/detail/pose__functions.h"  // pose
#include "rosidl_runtime_c/string.h"  // color, number, type
#include "rosidl_runtime_c/string_functions.h"  // color, number, type
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: kpts
  {
    ...
    size_t size = ros_message->kpts.size;
    auto array_ptr = ros_message->kpts.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: kpts
  {
    ...
    if (ros_message->kpts.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->kpts);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->kpts, size)) {
      fprintf(stderr, "failed to create array for field 'kpts'");
      return false;
    }
    auto array_ptr = ros_message->kpts.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  // field.name kpts
  {
    size_t array_size = ros_message->kpts.size;
    auto array_ptr = ros_message->kpts.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
