...
#define NODE_MAIN_LOGGER_NAME "virtual_serial_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_serial_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_serial_driver::VirtualSerialNode>";
