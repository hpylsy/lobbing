...
#define NODE_MAIN_LOGGER_NAME "lob_vision_node_exec"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblob_vision_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_auto_aim::LobVisionNode>";
