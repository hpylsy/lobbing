...
#define NODE_MAIN_LOGGER_NAME "rm_planner_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_planner.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_auto_aim::RMPlannerNode>";
